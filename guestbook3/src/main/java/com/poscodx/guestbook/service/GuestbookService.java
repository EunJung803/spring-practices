...
public class GuestbookService {
	...
	public void addContents(GuestbookVo vo) {
		...
		// 트랜잭션 동기화 (connection)
		TransactionSynchronizationManager.initSynchronization();		// 커넥션을 동기화 시켜줌, static 함수
		// 문제 있는 코드 -> 트랜잭션 매니저로 추상화 시켰다. 매니저 안에 다 숨겨져있다 이런게. 트랜잭션 경계 잡기
		Connection conn = DataSourceUtils.getConnection(dataSource);	// 데이터 소스도 커넥션이 있으니까 주입받아야함
